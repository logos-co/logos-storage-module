...
int storage_ctx_network(const StorageCtx* ctx, StorageStrReplyFn cb, void* userData) {
    LOGOS_CMOCK_RECORD("storage_ctx_network");
    invokeOk("storage_ctx_network", cb, userData);
    return RET_OK;
}
